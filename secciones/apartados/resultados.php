  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" id="top-nav">
        			<li>
                      <a id="BOD" href="index.php">Bodas</a>
                    </li>
                    <li><a id="XVA" href="index.php">XV años</a></li>
                    <li><a id="BAU" href="index.php">Bautizos</a></li>
                    <li><a id="COM" href="index.php">Comunión</a></li>
                    <li><a id="PRE" href="index.php">Presentaciones</a></li>
                    <li><a id="CAB" href="index.php">Caballero</a></li>
          </ul>
        </li>
      </ul>
	 ...
	 <div class="container">
            ...
            <?php
				switch($_COOKIE['sec'])
				{
					...
					case "BUS": echo "Area de Búsqueda"; break;
				}
			?>
