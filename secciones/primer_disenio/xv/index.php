           ...
           <div class="top-nav">
               <ul class="memenu skyblue">                   
                   ...
                   <li class="grid"><a id="PRE" href="../presentaciones/index.php">Presentaciones</a>
					...
					<li class="grid"><a id="COM" href="../comunion/index.php">Comunión</a>
...
<div class="product-model">	 
	 <div class="container">
			<ol class="breadcrumb">
		  <li><a href="#">Todo lo que necesitas para tus XV años lo tienes aquí.</a></li>
		 </ol>
			<h2>Todo para XV años</h2>			
				 ...
				 <section  class="sky-form">
					 <div class="product_right">
						 ...
						 <div class="tab1">
					      ...
					      <div class="tab8">
							 <ul class="place">								
								 <li class="sort">Libros</li>
								 <li class="by"><img src="../src/do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
									<a href="#"><p>Biblias</p></a>
									<a href="#"><p>Nvo. Testamento</p></a>
						     </div>
					      </div>
					      <div class="tab9">
							 <ul class="place">								
