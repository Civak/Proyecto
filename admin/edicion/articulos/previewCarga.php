...
<h3>1. Elige al menos una imagen.</h3><hr style="border-style:dashed; border-color:white;">
<div id="imagesUp" class="row">
  <div class="col-xs-6 col-md-3">
    ...
    <a href="#" class="thumbnail">
        ...
        <p><b id="borrar-img" class="btn btn-c1">Borrar</b></p>
  </div>
 <!------------------------------------------------------------>
  <br>
  <div class="col-xs-6 col-md-3">
...
<br><br><h3>2. Selecciona la sección, escribe código y descripción.</h3><hr style="border-style:dashed; border-color:white;">
<div class="row">
        <div class="col-xs-6 col-md-4">
          <div class=".col-xs-6" id="combos">
                <div class="form-group" id="combosec">
                  ...
                  <select class="form-control input-login" id="sec" name="sec">
                    <option value="">-------------------------</option>
      ...
      <div class="col-xs-6 col-md-4">
        <div class="form-group">
                        ...
                        <input type="text" class="form-control input-login" id="pre" name="pre" placeholder="0000.00">
                        <label for="usr"><b class="infoObligatoria">Existencia:</b></label>
                        <input type="text" class="form-control input-login" id="exis" name="exis" placeholder="0">
                        <label for="comment"><b class="infoObligatoria">Descripción:</b></label>
                        <textarea class="form-control input-login" rows="5" id="comment" id="des" name="des" placeholder="Escribe una descripción del artículo"></textarea>
        </div>
      </div>
        <div class="col-xs-6 col-md-4 text-center">
        <div class="checkbox">
  			<label><input type="checkbox"  value="pdf" id="genpdf" name="genpdf"><span style="color:#039 !important;">Generar PDF con Código de Barras</span></label>
		</div><hr style="border-style:dashed; border-color:white;" />
        <!------- FIN AREA DE dropdown E inicio de confirmacion-------------------------------------------->
            <p><h4>Guardar nuevo artículo</h4></p><hr style="border-style:dashed; border-color:white;">
            <button type="button" class="btn btn-c2" id="confirmar-art">Confirmar</button>
        </div>
</div>
</form>
<hr style="border-style:dashed; border-color:white;">
