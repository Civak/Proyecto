...
<div class="product-model">	 
	 <div class="container">
			<ol class="breadcrumb">
		  <li><a href="#">Todo lo que necesitas para ese momento especial tienes aquí.</a></li>
		 </ol>
			<h2>Todo para Caballero</h2>			
				 ...
				 <section  class="sky-form">
					 <div class="product_right">
						 ...
						 <div class="tab1">
						  ...
						  <div class="tab3">
							 <ul class="place">								
								 <li class="sort">Corbatas</li> 
								 <li class="by"><img src="../src/do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
									<a href="#"><p>Caballero</p></a>
									<a href="#"><p>Varios Colores</p></a>
						     </div>
					      </div>
